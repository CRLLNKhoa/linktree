...
export default function Shotting() {
  const [audio] = useState(
    typeof Audio !== "undefined" && new Audio("/sound/shoot2.mp3")
  ); const [audioReLoad] = useState(
    typeof Audio !== "undefined" && new Audio("/sound/reload2.mp3")
  );
  ...
  return (
   <>
     ...
     {reload &&  <div className="fixed top-0 right-0 left-0 z-50 cursor-default bottom-0"></div>}
   </>
  );
}
